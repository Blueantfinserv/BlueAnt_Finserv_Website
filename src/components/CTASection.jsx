        ...
        <div className="relative bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-[40px] p-12 md:p-24 text-center shadow-2xl shadow-indigo-500/30 overflow-hidden" data-aos="zoom-in">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-blue-100 text-lg max-w-2xl mx-auto fintech-subtitle font-medium">
              Open your free account now and get exclusive benefits. Join 3,000+ families who are already building their financial future with Blueant Finserv.
            </p>
            ...
            <div className="flex items-center gap-4">
              <div className="flex -space-x-4">
                ...
                <div className="w-10 h-10 rounded-full bg-orange-400 border-2 border-indigo-600 flex items-center justify-center text-white text-xs font-bold">3k+</div>
              </div>
              <div className="text-left">
                <p className="text-white font-bold text-sm">Join 3,000+ Happy Families</p>
