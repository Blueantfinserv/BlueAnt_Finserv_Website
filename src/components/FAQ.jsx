    ...
    <section className="bg-gradient-to-b from-[#f8fafc] to-[#eff6ff] py-[100px]">
      <div className="max-w-[800px] mx-auto px-4 sm:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-16" data-aos="fade-up">
          <div className="border border-purple-200 bg-purple-50 text-purple-600 px-4 py-1.5 rounded-full text-xs font-bold flex items-center gap-2 mb-6 shadow-sm">
              ...
              <div className="space-y-3">
                {group.items.map((item, ii) => {
                  ...
                  return (
                    ...
                    >
                      <div className="p-4 sm:px-5 flex justify-between items-center gap-4">
                        <h4 className="text-[14px] sm:text-[15px] font-bold text-slate-800 leading-snug">
                          {item.q}
                        </h4>
                        <div 
        ...
        <div className="mt-10 flex justify-center" data-aos="fade-up">
          <div className="bg-white border border-slate-200 rounded-xl py-4 px-5 text-center shadow-sm w-full max-w-[340px] sm:max-w-[380px]">
            <p className="text-slate-700 font-semibold text-[13px] sm:text-[14px] mb-3">
              Still have questions? Our advisors are happy to help.
            </p>
            <button 
              onClick={openConsultationModal}
              className="inline-flex items-center justify-center bg-indigo-500 hover:bg-indigo-600 text-white px-5 py-2.5 rounded-lg font-semibold text-[13px] sm:text-[14px] transition-all shadow-sm hover:shadow"
            >
              Talk to an Advisor →
            </button>
          </div>
